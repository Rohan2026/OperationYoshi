 ...
 * @version (2024-01-03)
 */
public class HuynhRohan extends Animal
{
  ...
  public HuynhRohan()
  {
    this("Rohan Huynh", "Green", 2); // Default is a black animal with 4 legs
  }
   ...
   */
  public HuynhRohan(String studentName, String color, int legs) {
  ...
  public String getDisposition() {
    return "friendly, loyal, and helpful";
  }
